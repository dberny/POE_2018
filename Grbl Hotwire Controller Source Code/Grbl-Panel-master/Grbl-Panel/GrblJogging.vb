...
Partial Class GrblGui
    Public Class GrblJogging
        ...
        Public Sub New(ByRef gui As GrblGui)
            ...
            With My.Settings
                ...
                _gui.btnUPlus.Interval = 1000 / .JoggingURepeat
                _gui.btnUMinus.Interval = 1000 / .JoggingURepeat
    ...
    Private Sub btnJogArray_Click(sender As Object, e As EventArgs) Handles btnXPlus.Click, btnXMinus.Click, btnYPlus.Click, btnYMinus.Click,
                                                                           btnZPlus.Click, btnZMinus.Click, btnUMinus.Click, btnUPlus.Click,
                                                                           btnUP.Click, btnDOWN.Click, btnBACK.Click, btnFORWARD.Click
        ...
        Select Case DirectCast(btn.Tag, String)
            ...
            Case "Z-"
                gcode.sendGCodeLine(createJogCommand("Z-"))
            Case "U+"
                gcode.sendGCodeLine(createJogCommand("U"))
            Case "U-"
                gcode.sendGCodeLine(createJogCommand("U-"))
            Case "UP"
                gcode.sendGCodeLine("G91 " + whichUnits() + " G01 " + "Y" + whichDistance() + " Z" + whichDistance() + " F" + whichFeedRate())
            Case "DOWN"
                gcode.sendGCodeLine("G91 " + whichUnits() + " G01 " + "Y-" + whichDistance() + " Z-" + whichDistance() + " F" + whichFeedRate())
            Case "BACK"
                gcode.sendGCodeLine("G91 " + whichUnits() + " G01 " + "X-" + whichDistance() + " U-" + whichDistance() + " F" + whichFeedRate())
            Case "FORWARD"
                gcode.sendGCodeLine("G91 " + whichUnits() + " G01 " + "X" + whichDistance() + " U" + whichDistance() + " F" + whichFeedRate())
        End Select
