...
Public Class GrblGui
                    ...
                    If _gui.cbSettingsKeyboardJogging.Checked Then
                        Select Case msg.WParam   ' ignoring modifiers for now
                            ...
                            Case Keys.Down
                                ...
                                handled = True
                            Case Keys.Control AndAlso Keys.Up
                                _gui.btnZPlus.PerformClick()
                                handled = True
                            Case Keys.Control AndAlso Keys.Down
                                _gui.btnZMinus.PerformClick()
                                handled = True
                            Case Keys.Control AndAlso Keys.Right
                                _gui.btnUPlus.PerformClick()
                                handled = True
                            Case Keys.Control AndAlso Keys.Left
                                _gui.btnUMinus.PerformClick()
                                handled = True
                        End Select
                        If handled Then
                            Return True
    ...
    Private Sub Hotwire_Click(sender As Object, e As EventArgs) Handles btnWorkX0.Click, btnWorkY0.Click, btnWorkZ0.Click, btnWorkU0.Click
        Dim btn As Button = sender
        Select Case DirectCast(btn.Tag, String)
            Case "X"
            ...
            Case "U"
                gcode.sendGCodeLine(My.Settings.WorkU0Cmd)
        End Select
