...
Partial Class GrblGui
    ...
    Public Class GrblGcode
        ...
        Public Shared _runMode As Boolean = True            '
        ...
        Private gTable As DataTable    ' to hold the parameters
        ...
        Public Function loadGCodeFile(ByVal file As String) As Boolean
            ...
            'Clear GCode Viewer
            GrblGui.XYchart.Series("Series1").Points.Clear()
            GrblGui.XYchart.Series("Series2").Points.Clear()

            GrblGui.UVchart.Series("Series1").Points.Clear()
            GrblGui.UVchart.Series("Series2").Points.Clear()

            'Data Table to show GCode on Graph
            gTable = New DataTable
            With gTable
                .Columns.Add("X")
                .Columns.Add("Y")
                .Columns.Add("U")
            ...
            Do While Not _inputfh.EndOfStream
                ...
                If data <> "%" Then
                    ...
                    'break GCode to get X Y Z U values
                    codes = data.Split({"X", "Y", "U", "Z", "F"}, options:=StringSplitOptions.None)
                    If codes(0).Contains("G0 ") Or codes(0).Contains("G1 ") Then
                        gTable.Rows.Add(codes(1), codes(2), codes(3), codes(4))
                    End If
            ...
            'Refresh GCode Viewer
            For i = 0 To gTable.Rows.Count - 1
                GrblGui.XYchart.Series("Series2").Points.AddXY(CDbl(gTable.Rows(i)(0)), gTable.Rows(i)(1))
                GrblGui.UVchart.Series("Series2").Points.AddXY(CDbl(gTable.Rows(i)(2)), gTable.Rows(i)(3))
            Next
